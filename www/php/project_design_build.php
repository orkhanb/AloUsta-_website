				...
				<div class="page-header-right">
					<div class="bread-crumb-container">
						...
						<ul class="bread-crumb">
							<li>
								<a title="Our Projects" href="?page=projects">
									OUR PROJECTS
								</a>
							</li>
							<li class="separator">
	...
	<div class="clearfix">
		<div class="row margin-top-70">
			<div class="column column-1-2">
				<a href="images/samples/750x500/image_10.jpg" class="prettyPhoto re-preload" title="Design and Build">
					<img src='images/samples/570x380/image_10.jpg' alt='img'>
				</a>
				<div class="row margin-top-30">
					<div class="column column-1-2">
						<a href="images/samples/750x500/image_02.jpg" class="prettyPhoto re-preload" title="Design and Build">
							<img src='images/samples/570x380/image_02.jpg' alt='img'>
						</a>
					</div>
					<div class="column column-1-2">
						<a href="images/samples/750x500/image_08.jpg" class="prettyPhoto re-preload" title="Design and Build">
							<img src='images/samples/570x380/image_08.jpg' alt='img'>
						</a>
					</div>
				</div>
				<div class="row margin-top-30">
					<a href="images/samples/750x500/image_01.jpg" class="prettyPhoto re-preload" title="Design and Build">
